...
export PYTHONPATH=$PYTHONPATH:/workspace/source/E2E-AD/TCP
...
export TEAM_CONFIG="/workspace/log/TCP/chkpt/ours_v1/ours_v1.2/best_epoch=11-val_loss=0.526.ckpt"
export CHECKPOINT_ENDPOINT=results_TCP.json
export SCENARIOS=leaderboard/data/scenarios/all_towns_traffic_scenarios.json
export SAVE_PATH=/workspace/log/TCP/qualitative_res/result_ours_v1.2
