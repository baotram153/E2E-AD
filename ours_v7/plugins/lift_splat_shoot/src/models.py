...
class Up(nn.Module):
    def __init__(self, in_channels, out_channels, scale_factor=2):
        ...
        self.up = nn.Upsample(scale_factor=scale_factor, mode='bilinear',   # align corner: make sure that the pixels at the corners are the same
                              align_corners=True)                           # between the original and the upsampled

        self.conv = nn.Sequential(            # notice the in_channels and out_channels
