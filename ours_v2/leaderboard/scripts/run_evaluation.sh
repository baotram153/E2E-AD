...
export PYTHONPATH=$PYTHONPATH:/workspace/source/E2E-AD/ours_v2
...
export TEAM_CONFIG="/workspace/log/TCP/chkpt/ours_v2/final_ctrl_weigh_0.05/best_epoch=11-val_loss=1.180.ckpt"
export CHECKPOINT_ENDPOINT=results_TCP.json
export SCENARIOS=leaderboard/data/scenarios/all_towns_traffic_scenarios.json
export SAVE_PATH=/workspace/log/TCP/qualitative_res/result_ours_v2
