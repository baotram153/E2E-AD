...
export TEAM_CONFIG="/workspace/log/TCP/chkpt/ours_v1/ours_v1.1/batch_size=8/best_epoch=11-val_loss=0.785.ckpt"
export CHECKPOINT_ENDPOINT=results_TCP.json
export SCENARIOS=leaderboard/data/scenarios/all_towns_traffic_scenarios.json
export SAVE_PATH=/workspace/log/TCP/qualitative_res/result_ours_v1.1
